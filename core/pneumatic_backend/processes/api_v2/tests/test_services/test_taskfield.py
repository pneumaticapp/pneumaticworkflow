...
def test_get_valid_radio_value__id__ok(mocker):
...
def test_get_valid_checkbox_value__one_id__ok(mocker):
...
def test_get_valid_checkbox_value__many_ids__ok(mocker):
