...
class TestUpdateUserProfileView:
    ...
    def test_update__all_fields__ok(self, mocker, api_client):
        ...
        identify_mock = mocker.patch(
            ...
            '.UpdateUserProfileView.identify'
        )
        ...
        assert data['date_fmt'] == request_data['date_fmt']
        assert data['date_fdw'] == request_data['date_fdw']
    ...
    def test_update__partial__update_request_fields(
        self,
        mocker,
        api_client
    ):
    ...
    def test_update__no_call_analytics__ok(self, mocker, api_client):
    ...
    def test_update__only_date_fmt__ok(self, mocker, api_client):
    ...
    def test_update__only_date_fdw__ok(self, mocker, api_client):
