...
from pneumatic_backend.processes.tests.fixtures import create_test_account
...
class TestGoogleCloudService:
    ...
    def test_init__with_account_no_bucket__ok(self, mocker):
        ...
        mocker.patch(
            'pneumatic_backend.storage.google_cloud.get_salt',
            return_value='salt'
        )
        mocker.patch(
            'pneumatic_backend.storage.google_cloud.AccountService',
