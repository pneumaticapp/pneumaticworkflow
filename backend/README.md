...
3. Use pyenv to install Python version Python 3.9.25. Command: ``pyenv install 3.9.25``.
4. Set Python 3.9.25 as the default version. Command: ``pyenv local 3.9.25``.
...
3. Download and install Python 3.9.13  ``https://www.python.org/downloads/release/python-3913/`` (the last 3.9 release with a Windows installer). During installation, make sure to check “Add Python to PATH.”
