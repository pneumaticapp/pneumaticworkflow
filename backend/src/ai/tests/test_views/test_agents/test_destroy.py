...
def test_destroy__by_owner__ok(api_client, mocker):
    ...
    delete_mock = mocker.patch(
        'src.ai.views.AIAgentService.delete',
    )
...
def test_destroy__service_exception__validation_error(
    ...
    """ Delete agent — service exception """
...
def test_destroy__not_admin__permission_denied(api_client):
