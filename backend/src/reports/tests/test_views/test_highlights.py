...
def test_highlights__task_complete_fieldsets_present__ok(api_client):
    ...
    """
    GET reports highlights: TASK_COMPLETE item includes non-null task.fieldsets
...
def test_highlights__task_complete_fieldsets_absent__ok(api_client):
    ...
    """
    GET reports highlights: TASK_COMPLETE item has task.fieldsets null when the
    task has no FieldSet rows.
    """
...
def test_highlights__non_complete_fieldsets_null__ok(api_client):

    """
    GET reports highlights: non-TASK_COMPLETE highlight exposes task.fieldsets
    as null.
    """
