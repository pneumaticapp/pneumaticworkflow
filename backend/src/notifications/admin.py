    ...
    fieldsets = (
        ...
        ('Content', {
            ...
            'description': (
                ...
                '{{variable_name}}.\n\n'
                'STANDARD VARIABLES:\n'
                '  {{logo_lg}} - company logo URL\n'
                '  Use {% now "Y" %} for current year,'
                ' {% now "d M, Y" %} for current date\n'
                '  All URLs are provided as complete links'
                ' (e.g. {{task_link}}, {{unsubscribe_link}})\n\n'
                ...
                '  {{task_link}}, {{link}} - link to task (full URL)\n'
                '  {{due_in}}, {{overdue}} - formatted time\n'
                '  {{started_by}} - {name, avatar} dict\n'
                '  {{unsubscribe_token}}, {{unsubscribe_link}}'
                ' - unsubscribe data\n'
                '  {{user_first_name}}, {{sender_name}} - user info\n\n'
                ...
                '  {{unsubscribe_token}}, {{unsubscribe_link}}'
                ' - unsubscribe data\n'
                '  {{user_name}} - user first name (for notifications)\n'
