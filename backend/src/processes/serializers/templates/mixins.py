...
class FieldsetMixin:
    ...
    def create_or_update_fieldsets(
        ...
        for fieldset_data in fieldsets_data:
            ...
            if fieldset_api_name and fieldset_api_name in existing_fieldsets:
                ...
                shared_fieldset = fieldset_data['shared_fieldset']
    ...
    def get_draft_fieldsets(self, data: Any):
        result = []
        if isinstance(data, list):
            for fieldset_data in data:
                if fieldset_data['fields']:
                ...
                try:
                    ...
                    continue
                service = FieldSetTemplateService()
                fieldset_data = service.get_new_fieldset_data(
                    shared_fieldset_data=FieldSetTemplateService.to_json(
                        shared_fieldset
                    ),
