...
def test_apply_show_rulesets__empty_list__skip():
    ...
    # act
    FieldRuleSetCheckService.apply_show_rulesets([], workflow_id=1)
...
def test_apply_show_rulesets_for_task__fieldset_field__recalculated():
    ...
    # act
    FieldRuleSetCheckService.apply_show_rulesets_for_task(task)
...
def test_apply_show_rulesets_for_workflow__fieldset_field__recalculated():
    ...
    # act
    FieldRuleSetCheckService.apply_show_rulesets_for_workflow(workflow)
...
def test_apply_show_for_workflow__kickoff_fieldset__ok():
