    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('is_deleted', models.BooleanField(default=False)),
                ('name', models.CharField(max_length=200)),
                ('type', models.CharField(choices=[('sum_max', 'Sum max')], default='sum_max', max_length=50)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(condition=models.Q(is_deleted=False), fields=('account', 'name'), name='fieldsettemplate_account_name_unique'),
        ),
    ]
