...
class WorkflowActionService:
    ...
    def start_workflow(self):
        ...
        FieldRuleSetCheckService.apply_show_rulesets_for_workflow(self.workflow)
    ...
    def complete_task_for_user(
        ...
        with transaction.atomic():
            ...
            # Workflow-wide: a show rule on the next task may read a
            # field just completed on this one.
