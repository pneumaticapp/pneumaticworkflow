...
class TestCheckPermissionView:
    ...
    def test_check_permission__invalid_data__bad_request(self, api_client):
        # arrange
        user = create_test_admin()
        api_client.token_authenticate(user)
    ...
    def test_check_permission__missing_file_id__bad_request(self, api_client):
        # arrange
        user = create_test_admin()
        api_client.token_authenticate(user)
    ...
    def test_check_permission__file_id_with_spaces__ok(self, api_client):
        # arrange
        user = create_test_admin()
        api_client.token_authenticate(user)
