...
def test_api_key__ok(api_client):
    ...
    APIKey.objects.create(
        ...
        prefix='pneu_test_prefix',
        key_hash=APIKey.hash_key('test_raw_key_value'),
    )
...
def test_api_key__user_without_api_key__ok(api_client):
    ...
    """ User without APIKey — has_api_key field is False """
    ...
    assert response.data[0]['has_api_key'] is False
    assert response.data[0]['api_key_count'] == 0
