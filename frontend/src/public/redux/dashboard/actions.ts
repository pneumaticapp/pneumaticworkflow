...
export const setIsDasboardLoaderVisible: (payload: boolean) => TSetIsLoaderVisible = actionGenerator<
  EDashboardActions.SetIsLoaderVisible,
  boolean
>(EDashboardActions.SetIsLoaderVisible);

export type TSetDashboardMode = ITypedReduxAction<EDashboardActions.SetDashboardMode, EDashboardModes>;
export const setDashboardMode: (payload: EDashboardModes) => TSetDashboardMode = actionGenerator<
  EDashboardActions.SetDashboardMode,
  EDashboardModes
>(EDashboardActions.SetDashboardMode);

export type TLoadDashboardData = ITypedReduxAction<EDashboardActions.LoadDashboardData, void>;
export const loadDashboardData: (payload?: void) => TLoadDashboardData = actionGenerator<
  EDashboardActions.LoadDashboardData,
  void
>(EDashboardActions.LoadDashboardData);

export type TSetDashboardCounters = ITypedReduxAction<EDashboardActions.SetDashboardCounters, IDashboardCounters>;
export const setDashboardCounters: (payload: IDashboardCounters) => TSetDashboardCounters = actionGenerator<
  EDashboardActions.SetDashboardCounters,
  IDashboardCounters
>(EDashboardActions.SetDashboardCounters);

export type TSetDashboardTimeRange = ITypedReduxAction<EDashboardActions.SetDashboardTimeRange, EDashboardTimeRange>;
export const setDashboardTimeRange: (payload: EDashboardTimeRange) => TSetDashboardTimeRange = actionGenerator<
  EDashboardActions.SetDashboardTimeRange,
  EDashboardTimeRange
>(EDashboardActions.SetDashboardTimeRange);

export type TLoadBreakdownItems = ITypedReduxAction<EDashboardActions.LoadBreakdownItems, EDashboardModes>;
export const loadBreakdownItems: (payload: EDashboardModes) => TLoadBreakdownItems = actionGenerator<
...
export type TLoadBreakdownTasks = ITypedReduxAction<EDashboardActions.LoadBreakdownTasks, ILoadBreakdownTasksPayload>;
export const loadBreakdownTasks: (payload: ILoadBreakdownTasksPayload) => TLoadBreakdownTasks = actionGenerator<
  EDashboardActions.LoadBreakdownTasks,
  ILoadBreakdownTasksPayload
>(EDashboardActions.LoadBreakdownTasks);

export type TSetBreakdownItems = ITypedReduxAction<EDashboardActions.SetBreakdownItems, TDashboardBreakdownItem[]>;
export const setBreakdownItems: (payload: TDashboardBreakdownItem[]) => TSetBreakdownItems = actionGenerator<
...
export const resetDashboardData: (payload?: void) => TResetDashboardData = actionGenerator<
  EDashboardActions.ResetDashboardData,
  void
>(EDashboardActions.ResetDashboardData);
...
export const patchBreakdownItem: (payload: TPatchBreakdownItemPayload) => TPatchBreakdownItem = actionGenerator<
  EDashboardActions.PatchBreakdownItem,
  TPatchBreakdownItemPayload
>(EDashboardActions.PatchBreakdownItem);

export type TSetSettingsManuallyChanged = ITypedReduxAction<EDashboardActions.SetSettingsManuallyChanged, void>;
export const setDashboardSettingsManuallyChanged: (payload?: void) => TSetSettingsManuallyChanged = actionGenerator<
  EDashboardActions.SetSettingsManuallyChanged,
  void
>(EDashboardActions.SetSettingsManuallyChanged);
...
export type TOpenRunWorkflowModalSideMenu = ITypedReduxAction<
  EDashboardActions.OpenRunWorkflowModalSideMenu,
  IOpenRunWorkflowSideMenuPayload
>;

export const openRunWorkflowModalSideMenu: (payload: IOpenRunWorkflowSideMenuPayload) => TOpenRunWorkflowModalSideMenu =
  actionGenerator<EDashboardActions.OpenRunWorkflowModalSideMenu, IOpenRunWorkflowSideMenuPayload>(
    EDashboardActions.OpenRunWorkflowModalSideMenu,
  );
...
export type TOpenRunWorkflowModalByTemplateId = ITypedReduxAction<
  EDashboardActions.OpenRunWorkflowModal,
  IOpenRunWorkflowPayload
>;

export const openRunWorkflowModalByTemplateId: (payload: IOpenRunWorkflowPayload) => TOpenRunWorkflowModalByTemplateId =
  actionGenerator<EDashboardActions.OpenRunWorkflowModal, IOpenRunWorkflowPayload>(
    EDashboardActions.OpenRunWorkflowModal,
  );

export type TLoadGettingStartedChecklist = ITypedReduxAction<EDashboardActions.LoadChecklist, void>;
export const loadGettingStartedChecklist: (payload?: void) => TLoadGettingStartedChecklist = actionGenerator<
  EDashboardActions.LoadChecklist,
  void
>(EDashboardActions.LoadChecklist);

export type TLoadGettingStartedChecklistSuccess = ITypedReduxAction<
  EDashboardActions.LoadChecklistSuccess,
  IGettingStartedChecklist
>;
export const loadGettingStartedChecklistSuccess: (
  payload: IGettingStartedChecklist,
) => TLoadGettingStartedChecklistSuccess = actionGenerator<
  EDashboardActions.LoadChecklistSuccess,
  IGettingStartedChecklist
>(EDashboardActions.LoadChecklistSuccess);
