...
export const loadApiKeys: (payload?: void) => TLoadApiKeys = actionGenerator<EIntegrationsActions.LoadApiKeys, void>(
  EIntegrationsActions.LoadApiKeys,
);

export type TLoadApiKeysSuccess = ITypedReduxAction<EIntegrationsActions.LoadApiKeysSuccess, IApiKeyItem[]>;
export const loadApiKeysSuccess: (payload: IApiKeyItem[]) => TLoadApiKeysSuccess = actionGenerator<
  EIntegrationsActions.LoadApiKeysSuccess,
  IApiKeyItem[]
>(EIntegrationsActions.LoadApiKeysSuccess);

export type TLoadApiKeysFailed = ITypedReduxAction<EIntegrationsActions.LoadApiKeysFailed, void>;
export const loadApiKeysFailed: (payload?: void) => TLoadApiKeysFailed = actionGenerator<
  EIntegrationsActions.LoadApiKeysFailed,
  void
>(EIntegrationsActions.LoadApiKeysFailed);
...
export const createApiKey: (payload: TCreateApiKeyPayload) => TCreateApiKey = actionGenerator<
  EIntegrationsActions.CreateApiKey,
  TCreateApiKeyPayload
>(EIntegrationsActions.CreateApiKey);

export type TCreateApiKeySuccessPayload = { apiKey: IApiKeyItem; rawKey: string };
export type TCreateApiKeySuccess = ITypedReduxAction<
  EIntegrationsActions.CreateApiKeySuccess,
  TCreateApiKeySuccessPayload
>;
export const createApiKeySuccess: (payload: TCreateApiKeySuccessPayload) => TCreateApiKeySuccess = actionGenerator<
  EIntegrationsActions.CreateApiKeySuccess,
  TCreateApiKeySuccessPayload
>(EIntegrationsActions.CreateApiKeySuccess);

export type TCreateApiKeyFailed = ITypedReduxAction<EIntegrationsActions.CreateApiKeyFailed, void>;
export const createApiKeyFailed: (payload?: void) => TCreateApiKeyFailed = actionGenerator<
  EIntegrationsActions.CreateApiKeyFailed,
  void
>(EIntegrationsActions.CreateApiKeyFailed);
...
export const deleteApiKey: (payload: TDeleteApiKeyPayload) => TDeleteApiKey = actionGenerator<
  EIntegrationsActions.DeleteApiKey,
  TDeleteApiKeyPayload
>(EIntegrationsActions.DeleteApiKey);

export type TDeleteApiKeySuccess = ITypedReduxAction<EIntegrationsActions.DeleteApiKeySuccess, { id: number }>;
export const deleteApiKeySuccess: (payload: { id: number }) => TDeleteApiKeySuccess = actionGenerator<
  EIntegrationsActions.DeleteApiKeySuccess,
  { id: number }
>(EIntegrationsActions.DeleteApiKeySuccess);

export type TDeleteApiKeyFailed = ITypedReduxAction<EIntegrationsActions.DeleteApiKeyFailed, void>;
export const deleteApiKeyFailed: (payload?: void) => TDeleteApiKeyFailed = actionGenerator<
  EIntegrationsActions.DeleteApiKeyFailed,
  void
>(EIntegrationsActions.DeleteApiKeyFailed);
...
export const clearNewlyCreatedKey: (payload?: void) => TClearNewlyCreatedKey = actionGenerator<
  EIntegrationsActions.ClearNewlyCreatedKey,
  void
>(EIntegrationsActions.ClearNewlyCreatedKey);

// Integrations List
export type TLoadIntegrationsList = ITypedReduxAction<EIntegrationsActions.LoadIntegrationsList, void>;
export const loadIntegrationsList: (payload?: void) => TLoadIntegrationsList = actionGenerator<
  EIntegrationsActions.LoadIntegrationsList,
  void
>(EIntegrationsActions.LoadIntegrationsList);
...
export const loadIntegrationsListFailed: (payload?: void) => TLoadIntegrationsListFailed = actionGenerator<
...
export const loadIntegrationDetails: (payload: TLoadIntegrationDetailsPayload) => TLoadIntegrationDetails =
  actionGenerator<EIntegrationsActions.LoadIntegrationDetails, TLoadIntegrationDetailsPayload>(
    EIntegrationsActions.LoadIntegrationDetails,
  );
...
export const loadIntegrationDetailsFailed: (payload?: void) => TLoadIntegrationDetailsFailed = actionGenerator<
  EIntegrationsActions.LoadIntegrationDetailsFailed,
  void
>(EIntegrationsActions.LoadIntegrationDetailsFailed);

export type TIntegrationsActions =
  | TLoadApiKeys
  | TLoadApiKeysSuccess
  | TLoadApiKeysFailed
  | TCreateApiKey
