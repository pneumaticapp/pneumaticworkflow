...
export const getFieldsetsList = (state: IApplicationState): IFieldsetCatalogItem[] =>
  state.fieldsets.fieldsetsList.items;
...
export const getFieldsetsSorting = (state: IApplicationState): EFieldsetsSorting =>
  state.fieldsets.fieldsetsListSorting;
...
export const getCurrentFieldset = (state: IApplicationState): IFieldsetCatalogItem | null =>
  state.fieldsets.currentFieldset;

export const isCurrentFieldsetLoading = (state: IApplicationState): boolean => state.fieldsets.isCurrentFieldsetLoading;

export const getFieldsetsCatalogItems = (state: IApplicationState): IFieldsetCatalogItem[] =>
  state.fieldsets.catalogAllFieldsets;
