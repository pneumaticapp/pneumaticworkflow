...
import { getAiAgentsSectionVisible } from '../selectors/aiAgents';
...
export function* generateMenuSaga() {
  try {
    ...
    const aiAgentsEnabled: ReturnType<typeof getAiAgentsSectionVisible> = yield select(getAiAgentsSectionVisible);
