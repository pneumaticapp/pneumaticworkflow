...
export type TLoadNotifications = ITypedReduxAction<
  ENotificationsActions.LoadList,
  ILoadNotificationsPayload | undefined
>;
export const loadNotificationsList: (payload?: ILoadNotificationsPayload | undefined) => TLoadNotifications =
  actionGenerator<ENotificationsActions.LoadList, ILoadNotificationsPayload | undefined>(
    ENotificationsActions.LoadList,
  );
...
export type TChangeNotificationsList = ITypedReduxAction<
  ENotificationsActions.ChangeList,
  IChangeNotificationsListPayload
>;
...
export const loadNotificationsListFailed: (payload?: void) => TLoadNotificationsListFailed = actionGenerator<
  ENotificationsActions.LoadListFailed,
  void
>(ENotificationsActions.LoadListFailed);

export type TSetNotificationsListIsOpen = ITypedReduxAction<ENotificationsActions.SetIsOpen, boolean>;
export const setNotificationsListIsOpen: (payload: boolean) => TSetNotificationsListIsOpen = actionGenerator<
  ENotificationsActions.SetIsOpen,
  boolean
>(ENotificationsActions.SetIsOpen);
...
>;
export const removeNotificationItem: (payload: TRemoveNotificationPayload) => TRemoveNotificationItem = actionGenerator<
  ENotificationsActions.RemoveNotificationItem,
  TRemoveNotificationPayload
>(ENotificationsActions.RemoveNotificationItem);

export type TChangeHasNewNotifications = ITypedReduxAction<ENotificationsActions.ChangeHasNew, boolean>;
export const changeHasNewNotifications: (payload: boolean) => TChangeHasNewNotifications = actionGenerator<
  ENotificationsActions.ChangeHasNew,
  boolean
>(ENotificationsActions.ChangeHasNew);

export type TFetchNotificationsAsRead = ITypedReduxAction<ENotificationsActions.FetchNotificationsAsRead, void>;
export const fetchNotificationsAsRead: (payload?: void) => TFetchNotificationsAsRead = actionGenerator<
  ENotificationsActions.FetchNotificationsAsRead,
  void
>(ENotificationsActions.FetchNotificationsAsRead);

export type TMarkNotificationsAsRead = ITypedReduxAction<ENotificationsActions.MarkNotificationsAsRead, void>;
export const markNotificationsAsRead: (payload?: void) => TMarkNotificationsAsRead = actionGenerator<
  ENotificationsActions.MarkNotificationsAsRead,
  void
>(ENotificationsActions.MarkNotificationsAsRead);

export type TChangeUnreadNotificationsCount = ITypedReduxAction<ENotificationsActions.ChangeUnreadCount, number>;
export const changeUnreadNotificationsCount: (payload: number) => TChangeUnreadNotificationsCount = actionGenerator<
  ENotificationsActions.ChangeUnreadCount,
  number
>(ENotificationsActions.ChangeUnreadCount);
