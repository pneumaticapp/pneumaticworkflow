...
import { ExtraFieldText } from '../ExtraFieldText';
...
describe('ExtraFieldText rulesets badge', () => {
  it('does not render rulesets badge when field has no rulesets', () => {
    renderWithIntl(<ExtraFieldText {...baseProps} />);
  ...
  it('does not render rulesets badge when rulesets array is empty', () => {
    ...
    renderWithIntl(<ExtraFieldText {...baseProps} field={field} />);
