...
export function ExtraFieldFilesGrid({ attachments, isEdit = false, isUploading, deleteFile }: IExtraFieldFilesGrid) {
  ...
  return (
    ...
    >
      {Boolean(isUploading) && <Loader isLoading={Boolean(isUploading)} />}
      {hasImages && (
