...
export function OutputFieldContent({
  ...
  const clearButton = (
    <button type="button" className={styles['output-field-content__clear-btn']} onClick={handleClearDataset}>
  ...
  const content =
    dataset && datasetName ? (
            ...
            >
              <span
                className={classnames(
                  styles['output-field-content__info-tag'],
                  styles['output-field-content__option-text'],
                )}
              >
                {datasetName}
              </span>
      ...
      <div className={styles['output-field-content__content']}>{children}</div>
    );

  return <div className={classnames(styles['output-field-content'], className)}>{content}</div>;
}
