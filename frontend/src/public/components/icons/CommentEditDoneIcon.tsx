...
export type TCommentEditDoneIconProps = React.SVGAttributes<SVGElement>;

export function CommentEditDoneIcon({ fill = 'currentColor', ...restProps }: TCommentEditDoneIconProps) {
  return (
