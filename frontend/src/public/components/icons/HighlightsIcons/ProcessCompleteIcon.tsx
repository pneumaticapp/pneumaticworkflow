  ...
  const smallIcon = (
    <svg width="20" height="20" viewBox="0 0 20 20" fill={fill} xmlns="http://www.w3.org/2000/svg" {...rest}>
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M2 4C2 2.89543 2.89543 2 4 2H9C10.6569 2 12 3.34315 12 5V11C12 12.1046 11.1046 13 10 13H4C2.89543 13 2 12.1046 2 11V4Z"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
        d="M10 6C10 4.89543 10.8954 4 12 4H15C16.6569 4 18 5.34315 18 7V12C18 13.6569 16.6569 15 15 15H13C11.3431 15 10 13.6569 10 12V6Z"
      />
      <path
        fillRule="evenodd"
        clipRule="evenodd"
