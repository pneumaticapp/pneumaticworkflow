...
export function QuestionIcon({
  ...
  return (
    <svg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg" {...rest}>
      ...
      <path
        d="M22.3 19.69C22.3 19.69 21.92 20.11 21.63 20.4C21.15 20.88 20.8 21.55 20.8 22H19.2C19.2 21.17 19.66 20.48 20.13 20L21.06 19.06C21.33 18.79 21.5 18.41 21.5 18C21.5 17.17 20.83 16.5 20 16.5C19.17 16.5 18.5 17.17 18.5 18H17C17 16.34 18.34 15 20 15C21.66 15 23 16.34 23 18C23 18.66 22.73 19.26 22.3 19.69Z"
        fill="#FEC336"
      />
    </svg>
  );
