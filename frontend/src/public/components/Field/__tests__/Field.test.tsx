...
jest.mock('../../RichEditor', () => ({
  RichEditor: ({ placeholder }: { placeholder?: string }) => <div data-testid="rich-editor">{placeholder}</div>,
}));
...
describe('Field component', () => {
  describe('Default input rendering', () => {
    it('renders input value, placeholder, and field type icon', () => {
      ...
      render(<Field value="Test text" placeholder="Enter value" icon={mockIcon} onChange={jest.fn()} />);
    ...
    it('disables input when disabled prop is true', () => {
      render(<Field value="Disabled value" disabled onChange={jest.fn()} />);
    ...
    it('fills its condition value container and preserves the inner spacing', () => {
      render(<Field value="" isFromConditionValueField onChange={jest.fn()} />);
  ...
  describe('Textarea rendering mode', () => {
    it('renders textarea with field type icon when tagName=Textarea', () => {
      ...
      render(<Field tagName={EFieldTagName.Textarea} value="Multiline text" icon={mockIcon} onChange={jest.fn()} />);
