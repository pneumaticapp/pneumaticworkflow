...
export const VerificationReminder = ({ isResendClicked, resendVerification }: IVerificationReminderProps) => {
  const verificationReminderClassName = classnames(styles['verification-reminder']);
