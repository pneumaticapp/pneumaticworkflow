...
export function HighlightsFeed({
  ...
  useEffect(() => {
    ...
    // The store default range ignores the profile timezone and can be stale after midnight.
  ...
  useEffect(() => {
    // Wait for the mount range before fetching titles, or a stale `takeEvery` request can win.
