...
export const GuestController = React.forwardRef<IGuestControllerHandle, IGuestControllerProps>(
  ({ taskId, className }, ref) => {
    ...
    const addGuest = React.useCallback<React.FormEventHandler<HTMLFormElement>>(
      (event) => {
